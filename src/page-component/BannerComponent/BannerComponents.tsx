...
import { LoTypography, NewTypography, OurTypography, StyledButton, SubDiv } from "./BannerComponent.styled";

const BannerComponent = ({ bannerData }: any) => {
  console.log('bannerData', bannerData);

  const bgImage = bannerData?.[0]?.productImage?.[0]?.bannerImage?.data?.[0]?.attributes;
